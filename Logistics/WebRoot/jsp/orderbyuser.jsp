	...
	<div id="package">
		...
		<div id="order-list-view">
			...
			<div id="order-list-header">
				...
				<ul>
					<li><span  id="header-native-1" onclick="changeColor(1),showInOrderByUser(1)">进行中</span>
					</li>
					<li><span id="header-native-2" onclick="changeColor(2),showInOrderByUser(0)">已完成</span>
					</li>
